...
train_data = mid_prices.to_()
test_data = mid_prices
#scaler = StandardScaler()
#train_data = scaler.fit_transform(mid_prices)
#test_data = scaler.fit_transform(mid_prices)
...
epochs = 30
valid_summary = 1 # Interval of test predictions

n_predict_once = 50 # Number of steps continously predicted
